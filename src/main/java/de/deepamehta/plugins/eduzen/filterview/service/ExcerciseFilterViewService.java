package de.deepamehta.plugins.eduzen.filterview.service;
...
public interface ExcerciseFilterViewService extends PluginService {

    Set<RelatedTopic> getExcerciseTextsByTopicalArea(long excerciseId, ClientState clientState);
